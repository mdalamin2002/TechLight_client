...
export default function Navbar() {
  ...
  return (
    <header className="bg-bgPrimary shadow-sm sticky top-0 z-50">
      {/* TOP NAV */}
        ...
        <div className="flex items-center space-x-4">
          ...
          {isLoggedIn ? (
            <div className="relative group">
              <img
                src={
                  user?.photoURL || "https://i.ibb.co.com/1tKbx3sx/avatar.jpg"
                }
                alt="User"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t shadow-inner flex justify-around py-2 z-50">
