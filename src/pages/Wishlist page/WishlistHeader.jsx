...
const WishlistHeader = ({ itemCount }) => {
  const handleShare = async () => {
    const shareData = {
      title: "My Wishlist",
      text: "Check out my wishlist on TechLight!",
    ...
    <div className="bg-gradient-to-br from-primary/10 via-background to-accent/5 border-b border-border/50">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-center sm:text-left">
          ...
          <button
            onClick={handleShare}
            className="flex items-center justify-center gap-2 px-3 py-2 sm:px-5 sm:py-2.5 bg-primary/90 text-primary-foreground rounded-lg hover:opacity-90 transition w-full sm:w-auto"
          >
